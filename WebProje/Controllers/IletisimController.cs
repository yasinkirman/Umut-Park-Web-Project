...
namespace WebProje.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Whatsapp,Instagram,Facebook,Email")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Whatsapp,Instagram,Facebook,Email")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
